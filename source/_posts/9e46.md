...
![](https://cdn.uzz5.com/imgs/2021/04/20/dBrDP98G.webp)

要在 `ShareX` 上实现这一效果，首先需要浏览器边框的原图，可以直接利用截图获得，注意格式最好是 `PNG`，以保留透明度。

![](https://cdn.uzz5.com/imgs/2021/04/20/Ef1EbTOT.webp)
...
![](https://cdn.uzz5.com/imgs/2021/04/20/hRbr4D3f.webp)
...
![](https://cdn.uzz5.com/imgs/2021/04/20/9ygrqLv2.webp)

类似的，我们也能制作一个 `Windows` 窗口风格的效果，给截图添加 `Windows` 窗口边框。

![](https://cdn.uzz5.com/imgs/2021/04/20/l4N8vbuo.webp)

## 添加手机模型框

另一个比较普遍的需求是给手机截图配上手机模型，ShareX 也能完成。

![](https://cdn.uzz5.com/imgs/2021/04/20/UPHxXWGc.webp)

首先仍然是寻找一个透明的手机模型图。FaceBook 提供了一些质量较高的真机模型图，自行抠图或绘制也可以。总之，需要有一个只有边框，其他部分都是透明的phone.png图，并且量出其可以覆盖的高宽。

![之前介紹的 https://www.deviceshots.com/ 也可以直接下載素材.](https://cdn.uzz5.com/imgs/2021/04/20/iY0LDedx.webp)

![](https://cdn.uzz5.com/imgs/2021/04/20/NrLDjkxk.webp)
...
![](https://cdn.uzz5.com/imgs/2021/04/20/w11QfVhP.webp)
...
![](https://cdn.uzz5.com/imgs/2021/04/20/rqDTY5jn.webp)
